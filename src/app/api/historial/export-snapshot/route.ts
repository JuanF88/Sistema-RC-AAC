...
async function createHistorialExcel(
  ...
  const bdColumns = [
    ...
    { key: "rcExecutoriaConceptDate", header: "Fecha concepto de ejecutoria RC" },
    ...
    { key: "aacExecutoriaConceptDate", header: "Fecha concepto de ejecutoria AAC" },
  ...
  programs.forEach((program, idx) => {
    const row = bdSheet.addRow({
      ...
      rcExecutoriaConceptDate: formatDate(program.rcExecutoriaConceptDate),
      ...
      aacExecutoriaConceptDate: formatDate(program.aacExecutoriaConceptDate),
