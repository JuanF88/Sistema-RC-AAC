...
const FULL_EXPORT_COLUMNS: ExportMatrixColumn[] = [
  ...
  { key: "degree", header: "Título otorgado", width: 26, getValue: (program) => program.degree },
  { key: "creationAgreement", header: "Acuerdo de Creación\nConsejo Superior", width: 28, getValue: (program) => program.creationAgreement },
  { key: "snies", header: "SNIES", width: 14, getValue: (program) => program.snies },
  { key: "noRenewal", header: "No Renovación", width: 18, getValue: (program) => program.noRenewal },
  { key: "authorizedAdmissionsMen", header: "Número de Admitidos autorizados por el MEN", width: 22, getValue: (program) => program.authorizedAdmissionsMen },
  { key: "admissionPeriodicity", header: "Periodicidad del admisión", width: 20, getValue: (program) => program.admissionPeriodicity },
  ...
  { key: "rcResolutionCopy", header: "Resolución\nR.C.", width: 18, getValue: (program) => program.rcResolution },
  { key: "rcStart", header: "Inicio R.C.", width: 14, getValue: (program) => formatDate(program.rcStart) },
  { key: "rcDurationYears", header: "Duración\n(años)", width: 12, getValue: (program) => program.rcDurationYears },
  ...
  { key: "rcExtensionDecree1330", header: "Extensión Decreto 1330 de 2019", width: 22, getValue: (program) => formatDate(program.rcExtensionDecree1330) },
  { key: "rcExtensionDecree1174", header: "Vencimiento de R.C con Extensión decreto 1174 de 2023", width: 26, getValue: (program) => formatDate(program.rcExtensionDecree1174) },
  { key: "rcHistoricalResolutions", header: "Histórico\nResoluciones R.C.", width: 24, getValue: (program) => program.rcHistoricalResolutions },
  { key: "rcResolutionCount", header: "Cantidad\nRes/Ren R.C.", width: 14, getValue: (program) => program.rcResolutionCount },
  { key: "rcOfficialResolution", header: "Resolución R.C.\nde Oficio", width: 20, getValue: (program) => program.rcOfficialResolution },
  { key: "rcDeniedResolution", header: "Resolución R.C.\nNegada", width: 20, getValue: (program) => program.rcDeniedResolution },
  ...
  { key: "accreditationGuideline", header: "Lineamiento Acreditación", width: 22, getValue: (program) => program.accreditationGuideline },
